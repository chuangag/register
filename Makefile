#############################################################################
# Makefile for building: register
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Nov 27 19:01:26 2016
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/register1.0.0 || $(MKDIR) .tmp/register1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/register1.0.0/ && $(COPY_FILE) --parents courseRecord.h doublySortedLinkedList.h hashTable.h objects.h .tmp/register1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/register1.0.0/ && (cd `dirname .tmp/register1.0.0` && $(TAR) register1.0.0.tar register1.0.0 && $(COMPRESS) register1.0.0.tar) && $(MOVE) `dirname .tmp/register1.0.0`/register1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/register1.0.0
